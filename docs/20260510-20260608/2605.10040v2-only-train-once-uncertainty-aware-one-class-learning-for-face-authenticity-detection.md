...
## 速览
**TLDR**：提出FADNet，一种仅需真实面部样本训练的单类学习框架，通过不确定性感知学习实现通用面部伪造检测。它能同时应对DeepFake和全合成人脸，在不接触伪造样本的情况下显著提升对未知生成范式的泛化能力，为人脸真实性验证提供了高效解决方案。 \
**Motivation**：单类学习用于通用人脸伪造检测，应对未知生成器。 \
